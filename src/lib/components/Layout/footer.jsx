...
import hoprTokenLogoSVG from '../../assets/hopr-logos/hopr-token-logo.svg'
import twitterSVG from '../../assets/social-networks/twitter.svg'
import telegramSVG from '../../assets/social-networks/telegram.svg'
import linkedinSVG from '../../assets/social-networks/linkedin.svg'
import githubSVG from '../../assets/social-networks/github.svg'
import mediumSVG from '../../assets/social-networks/medium.svg'
import youtubeSVG from '../../assets/social-networks/youtube.svg'
import discordSVG from '../../assets/social-networks/discord.svg'
    ...
    <SFooter>
      <Content>
        <LeftColumn className='left-column'>
          <Logo className='logo'>
            <img src={hoprTokenLogoSVG} alt="HOPR Logo" />
          </Logo>
